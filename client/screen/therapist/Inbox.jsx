...
export default function Inbox({navigation}) {
  ...
  const { therapist, loading: loadingTherapist, error: errorTherapist } = useSelector(state => state.therapist)
  ...
  const { clients, error: errorClient, loading: loadingClient } = useSelector(state => state.client)
  let chatWith = []
  ...
  } else if (loadingClient || loadingTherapist || loadingCollection) {
    return (
