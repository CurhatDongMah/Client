      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={tailwind('mt-16')}>
          ...
          }
          {
            ...
            {/* {
              !therapistDetail.status ? (
                <View style={{ width: widthWindow * 9 /10}}>
                  <Text style={tailwind('pt-2 text-lg text-gray-700 tracking-wider')}>CREATE ORDER</Text>
          ...
          <View>
              ...
              <Text style={tailwind('pt-2 text-lg text-gray-700 tracking-wider')}>PROFILE</Text>
              <View style={{ width: widthWindow * 9 /10}}>
                <View style={tailwind('mt-2')}>
                  <Text style={tailwind('text-lg text-gray-400 tracking-wider')}>Age</Text>
                  <Text 
                ...
                <Text style={tailwind('pt-4 text-lg text-gray-700 tracking-wider')}>REVIEW</Text>
                {
                  reviews.map(review => {
                    return (
